...
class PHPExcel
{
    ...
    */
    ...
    public function getSheetByCodeName($pName = '')
    {
     ...
     /**
     * Create a new ExcelData with one Worksheet
     */
    ...
    /**
     * Disconnect all worksheets from this ExcelData workbook object,
     *    typically so that the ExcelData object can be unset
     *
     */
