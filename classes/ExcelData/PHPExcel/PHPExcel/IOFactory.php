...
class PHPExcel_IOFactory
{
    ...
    private static $searchLocations = array(
        array( 'type' => 'IWriter', 'path' => 'ExcelData/Writer/{0}.php', 'class' => 'PHPExcel_Writer_{0}' ),
        array( 'type' => 'IReader', 'path' => 'ExcelData/Reader/{0}.php', 'class' => 'PHPExcel_Reader_{0}' )
    );
     ...
     * @param    string $location    Example: ExcelData/Writer/{0}.php
    ...
    /**
     * Loads ExcelData from file using automatic PHPExcel_Reader_IReader resolution
     *
     * @static
     * @access public
