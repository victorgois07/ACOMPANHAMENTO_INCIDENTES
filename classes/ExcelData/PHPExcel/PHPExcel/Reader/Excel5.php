...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /**
     * Reads names of the worksheets from a file, without parsing the whole file to a ExcelData object
     *
     * @param     string         $pFilename
     * @throws     PHPExcel_Reader_Exception
     */
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($isBuiltIn) {
                ...
                // user-defined; not supported by ExcelData
            }
        }
    }
    ...
    private function readPane()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($this->frozen) {
                ...
                // unfrozen panes; split windows; not supported by ExcelData core
            }
        }
    }
