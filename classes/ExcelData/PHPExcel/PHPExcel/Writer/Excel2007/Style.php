...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     *
     * @param     PHPExcel                $pPHPExcel
     * @return     PHPExcel_Style[]        All styles in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
     ...
     *
     * @param     PHPExcel                            $pPHPExcel
     * @return     PHPExcel_Style_Conditional[]        All conditional styles in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     PHPExcel_Style_Fill[]        All fills in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     PHPExcel_Style_Font[]        All fonts in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     PHPExcel_Style_Borders[]        All borders in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
     ...
     *
     * @param     PHPExcel                                $pPHPExcel
     * @return     PHPExcel_Style_NumberFormat[]        All number formats in ExcelData
     * @throws     PHPExcel_Writer_Exception
     */
