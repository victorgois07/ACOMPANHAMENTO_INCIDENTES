...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     *
     * @param    PHPExcel    $phpExcel    ExcelData object
     */
    ...
    {
        // ExcelData object known?
        if (is_null($this->phpExcel)) {
            throw new PHPExcel_Writer_Exception('Internal ExcelData object not set to an instance of an object.');
        }
        ...
        $html .= '<!-- Generated by ExcelData - http://www.phpexcel.net -->' . PHP_EOL;
        $html .= '<html>' . PHP_EOL;
        $html .= '  <head>' . PHP_EOL;
