...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            throw new PHPExcel_Writer_Exception("ExcelData object unassigned.");
        }
    }

    /**
     * Get ExcelData object
     *
     * @return PHPExcel
     * @throws PHPExcel_Writer_Exception
     */
    public function getPHPExcel()
    {
        if ($this->spreadSheet !== null) {
            ...
            throw new PHPExcel_Writer_Exception("No ExcelData object assigned.");
        }
    }

    /**
     * Set ExcelData object
     *
     * @param     PHPExcel     $pPHPExcel    ExcelData object
     * @throws    PHPExcel_Writer_Exception
