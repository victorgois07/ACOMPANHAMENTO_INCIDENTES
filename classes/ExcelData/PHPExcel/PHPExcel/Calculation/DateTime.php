...
class PHPExcel_Calculation_DateTime
{
     ...
     * and time format of your regional settings. ExcelData does not change cell formatting in this way.
     *
     * Excel Function:
     *        NOW()
     *
     ...
     *
     * NOTE: When used in a Cell Formula, MS Excel changes the cell format so that it matches the date
     * format of your regional settings. ExcelData does not change cell formatting in this way.
     *
     * Excel Function:
     *        DATE(year,month,day)
     *
     * ExcelData is a lot more forgiving than MS Excel when passing non numeric values to this function.
