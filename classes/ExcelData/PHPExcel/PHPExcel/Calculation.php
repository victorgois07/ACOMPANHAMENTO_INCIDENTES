...
class PHPExcel_Calculation
{
    ...
    {
        $localeFileDirectory = PHPEXCEL_ROOT.'ExcelData/locale/';
     ...
     *
     * @access    public
     * @param   PHPExcel $workbook  Injected workbook for working with a ExcelData object,
...
//echo 'ExcelData function '.$functionName, PHP_EOL;
...
//                    echo 'Token is a ExcelData constant: '.$excelConstant.'<br />';
